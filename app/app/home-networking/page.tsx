        ...
        <section className="relative overflow-hidden border-b border-border">
          ...
          <div className="relative mx-auto grid min-h-[650px] max-w-6xl items-center gap-14 px-6 pt-32 pb-20 lg:grid-cols-[1.1fr_0.9fr] lg:gap-24">
            ...
            <div className="border-y border-border py-6">
              <p className="font-mono text-[11px] tracking-[0.14em] text-primary uppercase">What we set up</p>
              <div className="mt-5 divide-y divide-border">
                {offerings.map((service) => <div key={service.id} className="flex items-center justify-between gap-4 py-4 text-sm"><span className="font-medium text-foreground">{service.title}</span><span className="text-right text-xs text-text-secondary">{service.short}</span></div>)}
              </div>
            </div>
          </div>
        </section>
