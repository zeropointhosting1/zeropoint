          ...
          <div className="grid md:grid-cols-2">
            <div className="p-6 sm:p-7 md:border-r md:border-border">
              <div className="flex items-start justify-between gap-4">
                ...
                <span className="rounded-full border border-success/20 bg-success/5 px-2.5 py-1 font-mono text-[11px] tracking-wider text-success uppercase">Available now</span>
              </div>
              ...
              <p className="mt-4 font-mono text-[11px] leading-relaxed tracking-wide text-text-tertiary uppercase">Small, sourced app catalog first. Expanded as the data earns trust.</p>
            ...
            <div className="border-t border-border p-6 sm:p-7 md:border-t-0">
              <div className="flex items-start justify-between gap-4">
                ...
                <span className="flex items-center gap-1.5 rounded-full border border-success/20 bg-success/5 px-2.5 py-1 font-mono text-[11px] tracking-wider text-success uppercase"><span className="size-1 rounded-full bg-success" />Available now</span>
              </div>
